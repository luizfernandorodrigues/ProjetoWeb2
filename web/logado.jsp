<%
    String login = "" + session.getAttribute("loginUsuario"); // Login
    String adm = "" + session.getAttribute("usuarioAdm");
%>
<%-- 
   Document   : index
...
<html>
    ...
    <body>
        <div class="banner">
            ...
            <span class = "bem-vindo">Olá, <%=login%>!</span>
            <a class = "sair" href="logoff.jsp">Sair</a>
            <a href="ManipulaBanco.jsp"></a>
        </div>
